...
public class StudentOrder {
    ...
    public StudentOrderStatus getStatus() {return status; }
    public void setStatus(StudentOrderStatus status) {this.status = status; }
    ...
    public List<StudentOrderChild> getChildren() {return children;}
    public void setChildren(List<StudentOrderChild> children) {this.children = children;}
}
